        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OverrideNl = table.Column<string>(type: "TEXT", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "TEXT", nullable: false),
                    RoadmapItemId = table.Column<Guid>(type: "TEXT", nullable: false),
                    SummaryNl = table.Column<string>(type: "TEXT", nullable: false),
                    WhyItMattersNl = table.Column<string>(type: "TEXT", nullable: false),
                    ActionRequiredNl = table.Column<string>(type: "TEXT", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RoadmapItemId = table.Column<Guid>(type: "TEXT", nullable: false),
                    TitleNl = table.Column<string>(type: "TEXT", nullable: false),
                    SummaryNl = table.Column<string>(type: "TEXT", nullable: false),
                    ActionNl = table.Column<string>(type: "TEXT", nullable: false),
                    ChangeType = table.Column<int>(type: "INTEGER", nullable: false),
                    GaDate = table.Column<DateOnly>(type: "TEXT", nullable: true),
                    EffortBand = table.Column<int>(type: "INTEGER", nullable: false),
                    Decision = table.Column<int>(type: "INTEGER", nullable: false),
